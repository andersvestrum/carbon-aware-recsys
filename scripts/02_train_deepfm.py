...
Usage:
    python scripts/02_train_deepfm.py                          # all categories
    python scripts/02_train_deepfm.py --category electronics
    python scripts/02_train_deepfm.py --model LightGCN
    python scripts/02_train_deepfm.py --config configs/deepfm/default.yaml
"""
...
def main():
    ...
    log.info("DeepFM training complete. Run 03_rerank.py next.")
