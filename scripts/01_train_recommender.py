...
Usage:
  ...
  python scripts/01_train_recommender.py --model SASRec
  python scripts/01_train_recommender.py --model LightGCN
  python scripts/01_train_recommender.py --fallback             # numpy BPR (no RecBole)
"""
...
def main():
    ...
    log.info("Candidate generation complete. Run 02_train_deepfm.py next.")
