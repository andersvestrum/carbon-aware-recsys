...
\emph{substitutability} and \emph{score sharpness}. Categories such as
Home \& Kitchen exhibit high substitutability, where many items provide
similar utility but differ in carbon footprint, allowing re-ranking to
replace higher-carbon items with lower-carbon alternatives at minimal
relevance cost. In contrast, categories such as Electronics contain more
functionally distinct items, limiting the availability of low-carbon
substitutes. At the model level, NeuMF produces more peaked relevance
...
all models and categories, we observe a consistent \emph{plateau--cliff} pattern: for a
...
to incorporate environmental objectives without sacrificing user experience. Given the scale of modern recommender systems, even small per-user reductions
in carbon exposure could translate into substantial aggregate environmental
impact.
% ----------------------------
% Bibliography
% ----------------------------
