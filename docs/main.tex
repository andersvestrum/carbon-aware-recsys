...
realistic large-scale setting where labels are absent for most items and PCF must be
estimated for sampled Amazon catalog subsets across three product categories. The
