...
all three recommenders within each category. Additional per-category Pareto plots are provided in the appendix
...
Finally, $\lambda$ functions as an explicit policy lever. It exposes the engagement-sustainability trade-off directly, making the system easier to inspect, tune, and audit
